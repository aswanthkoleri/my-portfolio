...
const Hero = () => {
  ...
  const role = useRoleSwitcher({ roles: ['SENIOR SOFTWARE ENGINEER', 'FRONTEND ENGINEER AT SCALER', 'FULLSTACK DEVELOPER'] })
    ...
    <section className="bg-primary bg-small-glow bg-small-glow-position md:bg-large-glow-position lg:bg-large-glow min-h-[calc(dvh-4rem)] bg-no-repeat">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-4 px-4 pt-12 pb-10 md:grid-cols-2 lg:p-4">
        <div className="flex min-h-48 flex-col justify-between lg:min-h-56 lg:max-w-[33.75rem]">
          <h1>
            <span className="text-neutral mb-2 block text-3xl font-bold">Hi - I'm Aswanth K Anil</span>
          ...
          <div className="mt-6 flex flex-wrap gap-6">
            <a
              href="https://my-resume-9a8ui7cvn-aswanth-ks-projects-0799e9fe.vercel.app/"
              aria-label="Connect with me"
              className="bg-accent min-w-32 cursor-pointer rounded-lg px-[14px] py-[10px] text-center text-sm font-medium text-[#00071E]">
              View my Resume
            </a>
            <a
              href="https://www.linkedin.com/in/aswanthkoleri/"
        ...
        <div className="flex min-h-[18.75rem] items-center justify-center lg:min-h-[35rem]">
          <div className="text-accent relative size-56 sm:size-60 md:size-[20rem] lg:size-[25.75rem]">
            <Image
              ...
              alt="Aswanth K Anil - Full Stack Developer"
